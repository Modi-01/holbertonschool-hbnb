...
class PlaceResource(Resource):
    ...
    def put(self, place_id):
        ...
        allowed_fields = {"title", "description", "price", "country"}
        has_extra = set(data.keys()) - allowed_fields

        if has_extra:
            return {"error": "You can only update title, description, price, or country"}, 400
